...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .topbar { background:var(--white); border-bottom:1px solid var(--gray2); padding:14px 28px; display:flex; align-items:center; gap:12px; flex-wrap:wrap; }
        .topbar-back { color:var(--muted); font-size:13px; display:flex; align-items:center; gap:5px; }
        .topbar-back:hover { color:var(--navy); }
        .topbar-title { font-family:'Montserrat',sans-serif; font-size:16px; font-weight:700; color:var(--navy); flex:1; }
        ...
        .info-label { color:var(--muted); flex-shrink:0; min-width:130px; }
        .info-value { font-weight:600; color:var(--navy); text-align:right; }

        /* CHECKLIST */
        .checklist { display:flex; flex-direction:column; gap:8px; }
        .check-item { display:flex; align-items:center; gap:10px; padding:10px 14px; border:1px solid var(--gray2); border-radius:8px; font-size:13px; transition:border-color .15s; }
        ...
        .check-item.missing { background:var(--red-bg); border-color:#F09595; }
        ...
        .check-dot.missing { background:var(--red); color:white; }
        .check-label { flex:1; }
        ...
        .nota-delete { position:absolute; top:10px; right:10px; background:none; border:none; color:var(--muted); cursor:pointer; font-size:14px; line-height:1; }
...
<div class="shell">
    ...
    <div class="main">
        <div class="topbar">
            ...
            <div class="topbar-actions">
                <a href="{{ route('admin.tramites.documentos', $tramite) }}" class="btn btn-ghost btn-sm">Ver documentos</a>
            </div>
        </div>
            ...
            <div class="content-inner">
                ...
                <div class="hero-card">
                    <div class="hero-left">
                        ...
                        <p>{{ $tramite->tipo_entidad }} · {{ $tramite->jurisdiccion }} · {{ $tramite->user->name }} · {{ $tramite->user->email }}</p>
                    ...
                    <div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.tramites.registro', $tramite) }}">
                                    ...
                                    <textarea name="notas_internas" placeholder="Observaciones internas, pasos realizados, pendientes...">{{ $tramite->notas_internas }}</textarea>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="info-row"><span class="info-label">Nombre empresa</span><span class="info-value">{{ $tramite->nombre_empresa ?? '—' }}</span></div>
                                ...
                                <div class="info-row"><span class="info-label">Dirección envío</span><span class="info-value">{{ $tramite->direccion_envio ?? '—' }}</span></div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.tramites.documentos.admin', $tramite) }}"
              enctype="multipart/form-data">
            @csrf
            <label>Tipo de documento</label>
            <select name="tipo" style="width:100%;padding:9px 12px;border:1px solid var(--gray2);border-radius:6px;font-size:13px;margin-bottom:14px;outline:none">
