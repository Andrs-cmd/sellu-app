...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .pbr-subtitle { font-size:18px;line-height:30px;color:#5b607d;max-width:720px;margin:0 auto;font-family:'Montserrat',sans-serif; }
    .pbr-definition { display:grid;grid-template-columns:220px 1fr;gap:32px;align-items:start;padding:28px 32px;background:#fff;border:1px solid #e0e0e0;border-left:3px solid #434966;border-radius:14px;box-shadow:0 2px 8px rgba(0,0,0,0.06);margin-bottom:56px;position:relative;z-index:1; }
    .pbr-term { font-family:'Montserrat',sans-serif;font-weight:700;font-size:14px;letter-spacing:0.06em;text-transform:uppercase;color:#434966; }
    .pbr-term-full { display:block;font-size:12px;letter-spacing:0.08em;color:#6b6f7a;font-weight:500;margin-top:6px;text-transform:none;font-family:'JetBrains Mono',monospace; }
    .pbr-desc { font-size:16px;line-height:26px;color:#3a3d46;font-family:'Montserrat',sans-serif; }
    ...
    .pbr-close-eyebrow { color:#f6bb33;font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;margin-bottom:12px;display:block;font-family:'Montserrat',sans-serif; }
    .pbr-close p { font-family:'Montserrat',sans-serif;font-weight:500;font-size:21px;line-height:32px;letter-spacing:-0.01em;color:#fbfaf7;margin:0;max-width:640px; }
    .pbr-brand { color:#f6bb33;font-weight:700; }
    .pbr-checks { display:flex;flex-wrap:wrap;gap:8px 18px;margin-top:20px;font-size:13px;color:rgba(251,250,247,0.75);font-family:'Montserrat',sans-serif; }
    .pbr-checks span { display:inline-flex;align-items:center;gap:6px; }
    .pbr-checks i { color:#f6bb33; }
    .pbr-cta { display:inline-flex;align-items:center;gap:8px;background:#f6bb33;color:#434966;font-family:'Montserrat',sans-serif;font-weight:700;font-size:15px;padding:14px 22px;border-radius:12px;text-decoration:none;white-space:nowrap;transition:background 200ms,box-shadow 200ms; }
    .pbr-cta:hover { background:#f9cc66;box-shadow:0 6px 18px rgba(246,187,51,0.4); }
    @media (max-width:980px) { .pbr-grid{grid-template-columns:repeat(2,1fr)!important} .pbr-title{font-size:38px!important;line-height:48px!important} .pbr-definition{grid-template-columns:1fr!important;gap:12px!important} .pbr-close{grid-template-columns:1fr!important;padding:32px!important} }
    @media (max-width:600px) { .pbr-section{padding:80px 0 72px!important} .pbr-grid{grid-template-columns:1fr!important} .pbr-title{font-size:30px!important;line-height:40px!important} }
    </style>
</head>
<body>
<x-nav />
