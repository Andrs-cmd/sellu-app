...
<head>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .pull-quote-wrap { position: relative; margin-top: 24px; border-radius: 20px; overflow: hidden; }
    ...
    .diff-icon { width: 56px; height: 56px; border-radius: 14px; background: #F5A623; color: #0D1B3E; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 22px; }
