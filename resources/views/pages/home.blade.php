    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media(max-width:900px) {
            ...
            .cta-asesor-img { min-height:120px; }
...
<section id="servicios" class="servicios" aria-label="Nuestros servicios">
    ...
    <div class="servicios-grid">
        <a href="{{ url('/abre-empresa') }}" class="servicio-card" aria-label="Crea tu empresa en USA">
        ...
        <a href="{{ url('/contabilidad') }}" class="servicio-card" aria-label="Contabilidad e impuestos">
            <div class="servicio-icon">
        ...
        <a href="{{ url('/marca') }}" class="servicio-card" aria-label="Registro de marca USPTO">
            <div class="servicio-icon">
        ...
        <a href="{{ url('/sanitario') }}" class="servicio-card dark" aria-label="Registro sanitario FDA">
            <div class="servicio-icon">
        ...
        <a href="{{ url('/envios') }}" class="servicio-card dark" aria-label="Logística y envíos">
            <div class="servicio-icon">
        ...
        <a href="{{ url('/amazon') }}" class="servicio-card dark" aria-label="Vende en Amazon">
            <div class="servicio-icon">
    ...
    <div class="footer-inner">
        <div class="footer-top">
            <div>
                ...
                <address class="footer-brand-info" style="font-style:normal">
                    Ubicación: Spring Hill, Florida, Zipcode 34609<br>
                    Email: <a href="mailto:contacto@sellu.co">contacto@sellu.co</a><br>
                    Teléfono: <a href="tel:+19542105405">+1 954 210 5405</a><br>
